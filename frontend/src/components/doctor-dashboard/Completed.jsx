...
const Completed = () => {
  ...
  useEffect(() => {
    AxiosInstance.get(`http://localhost:7400/appointments/complete/doctor/${userId}`)
      .then((response) => {
    ...
    <>
      <Container>
        <Row className="mt-4 mb-4 justify-content-center">
          ...
          <h2 className="m-4 text-white">{apps.length === 0 && "There Are No "}Completed Appointments</h2>
          </Col>
        </Row>
        ...
        {currentApps.map((app, index) => (
          <Col key={index} xs="12" md="3" lg="4" xl="3" className="mb-2">
            ...
            <CardBody>
              ...
              <Row>
                <div className="col">
                  <CardTitle tag="h5" className="text-uppercase text-black mb-0">
